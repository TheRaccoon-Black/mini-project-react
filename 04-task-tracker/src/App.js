...
function App() {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold py-6 pl-6">04-Task Tracker</h1>
      ...
      <div className="w-full">
        <h2 className="text-xl font-semibold w-3/4 max-w-lg my-4 py-1 px-4 bg-gray-200">To Do</h2>
      ...
      <div className="w-full flex flex-col" ref={drop}>
        <h2 className="ml-6 text-xl font-semibold w-3/4 max-w-lg my-4 py-1 px-4 bg-gray-200">Completed: </h2>
        {
